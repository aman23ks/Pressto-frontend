...
import { TopNav } from "@/app/common/TopNav";
...
const NewOrder = ({ onBack }: { onBack: () => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold">{t("newOrders.newOrders")}</h1>
        </div>
        ...
        {!selectedShop ? (
          <>
            ...
            <div className="relative mb-6">
              ...
              <input
                type="text"
                placeholder={t("newOrders.searchForShop") + "..."}
            ...
            {loading ? (
                ...
                {filteredShops.map((shop) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-gray-600">
                          {shop.services?.length || 0} {t("newOrders.services")}
                        </p>
                        <p className="text-sm text-gray-600 mt-1">
                          {shop.totalOrders}+ {t("newOrders.orders")}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center text-sm text-gray-600 mt-2">
                      ...
                      <span>
                        {t("newOrders.deliveryIn") + " "} {shop.deliveryTime}
                      </span>
                    </div>
                  </div>
                ))}
              ...
              <div className="text-center py-12 bg-white rounded-xl border">
                <p className="text-gray-600">{t("newOrders.noShopFound")}</p>
              </div>
            )}
          </>
        ) : (
          <>
            ...
            <div className="bg-white rounded-xl border p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between font-medium text-lg pt-3 border-t">
                  <span>{t("newOrders.totalAmount")}</span>
            ...
            >
              {t("newOrders.continueToBookOrder")}
            </button>
          </>
        )}
      </main>
