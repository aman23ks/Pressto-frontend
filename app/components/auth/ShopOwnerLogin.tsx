...
export const ShopOwnerLogin = ({ onBack, onSwitch, onSuccess }: AuthProps) => {
  const { login } = useAuth();
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 ml-2">Shop Owner Login</h2>
            </div>
            <p className="text-gray-600 mb-6">Welcome back! Please login to your shop account</p>
